...
DEFAULT_TRAIN_LOSS_WEIGHT_CFG = {
    # Main segmentation loss is always used; this weight controls the auxiliary
    # dense guidance supervision strength. Retrieval-specific auxiliary losses
    # were removed.
    "dense_main": 0.50,
}
...
class TrainConfig:
    ...
    save_path: str = "USTS.pth"
    text_dir: str = "./text_features_llm"
